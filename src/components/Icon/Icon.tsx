...
export const PlusIcon: React.FC<IconProps> = ({ ...props }) => {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M8 1V15M1 8H15" stroke-width="2" stroke-linecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const Arrow: React.FC<IconProps> = ({ ...props }) => {
  return (
    <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M7 17V1M7 1L1 7M7 1L13 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
...
export const FilterIcon: React.FC<IconProps> = ({ ...props }) => {
  return (
    <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M4 7H16M1 1H19M7 13H13" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
