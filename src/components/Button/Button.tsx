...
const style = {
  primary: 'bg-primary border border-primary active:bg-primary-900 hover:bg-primary-600 text-base-500',
  default: 'active:bg-gray-100 hover:bg-gray-50 text-inverted border-tertiary border',
  borderless: 'active:bg-gray-100 hover:bg-gray-50 text-inverted',
  filter: 'text-primary bg-secondary',
  disabled: 'bg-gray-100 text-gray-300 border-gray-300',
